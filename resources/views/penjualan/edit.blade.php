            ...
            <div class="box-body">
                ...
                <form class="form-produk">
                    ...
                    <div class="form-group row">
                        <label for="kode_produk" class="col-lg-2">Nomor Penjualan</label>
                        <div class="col-lg-5">
                            <div class="input-group">
                              
                                <input type="text" class="form-control" readonly value="{{$id_penjualan}}" name="kode_produk" id="kode_produk">
                                <span class="input-group-btn">
                                    <button disabled class="btn btn-info btn-flat" type="button"><i class="fa fa-arrow-right"></i></button>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.edit2') }}" class="form-penjualan" method="post">
                            @csrf
...
<script>
    ...
    $(function () {
        ...
        table = $('.table-penjualan').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('transaksi.data2', $id_penjualan) }}',
            },
            columns: [
