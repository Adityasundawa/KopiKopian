...
<body onload="window.print()">
    ...
    <center>
        <img src=" {{ url('/') }}/img/cemara.JPG" class="img-fluid" style="width: 100px; height: auto" alt="" srcset="">
    </center>
    ...
    <p style="float: left;">No: {{ tambah_nol_didepan($penjualan->id_penjualan, 10) }}</p>
    <p style="float: right">Status : {{$penjualan->status}}</p>
    <p></p>
